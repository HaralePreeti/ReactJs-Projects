...
import './HooksFunctionEx.css';

function HooksFunctionEx() {
    const [count, setCount] = useState(6.00);
    const onSubClick = () => {
        setCount(count + 1);
    
    // const [count2, setCount] = useState(6.00);
    // const onLikeClick = () => {
    //     setCount(count + 1);
    // }
}
        ...
        <div className="parent">
            <div className="youtube">
                ...
                <div className="child">
                    ...
                    <h1>BKShivani</h1>
                    <p></p>
                    <h5>@bkshivani   <u><i>{count}M</i> </u>   Subscribers 1.4K Vidoes</h5>
                    <h5>Spiritual Guide and Mentor...</h5>
                    <span>Know more</span>
                    <br></br>
                    <br></br>
                    <button onClick={onSubClick}>Subscribe</button>
...
export default HooksFunctionEx;